...
namespace Nesk\Puphpeteer\Tests\Rialto;

use Nesk\Puphpeteer\Rialto\{Data\JsFunction, Exceptions\Node, Data\BasicResource};
use Nesk\Puphpeteer\Tests\Rialto\Implementation\{FsWithProcessDelegation, FsWithoutProcessDelegation, Resources\Stats};
...
final class ImplementationTest extends TestCase
{
    ...
    public const JS_FUNCTION_CREATE_DEPRECATION_PATTERN = '/^Nesk\\\\Puphpeteer\\\\Rialto\\\\Data\\\\JsFunction::create\(\)/';
    ...
    {
        self::expectException(FatalException::class);
    ...
    {
        $result = $this->fs->accessSync('tests/Rialto/resources/file');
    ...
    {
        self::expectException(ReadSocketTimeoutException::class);
    ...
    public function process_status_is_tracked()
    {
        ...
        $this->expectException(ProcessUnexpectedlyTerminatedException::class);
